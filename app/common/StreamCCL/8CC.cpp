...
int connectedComponent(int *, int *, int, int);
...
int connectedComponent(int *image, int* coordinates, int height, int width) {
    ...
    if (root != NULL) {
        ...
        for (labelCount = 1; labelCount <= labelArr[currentLabel-1]; labelCount++) {
